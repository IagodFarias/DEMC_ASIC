...
# Generated on: Sat Sep 12 10:35:25 -03 2026 (Sat Sep 12 13:35:25 UTC 2026)
...
set_log_file fv/ecc_design/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/ecc_design -revised fv_map
...
add_search_path /home/mateusmaia45/IHP-Open-PDK/ihp-sg13g2/libs.ref/sg13g2_stdcell/lib -library -both
read_library -liberty -both /home/mateusmaia45/IHP-Open-PDK/ihp-sg13g2/libs.ref/sg13g2_stdcell/lib/sg13g2_stdcell_typ_1p20V_25C.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../rtl/MRSC_encoder.sv ../rtl/MRSC_decoder.sv ../rtl/TBEC_RSC_encoder.sv ../rtl/TBEC_RSC_decoder.sv
delete_search_path -all -design -golden
add_search_path ../rtl -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../rtl/ecc_design.sv
elaborate_design -golden -root {ecc_design} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/ecc_design/fv_map.v.gz
elaborate_design -revised -root {ecc_design}
...
#add_name_alias fv/ecc_design/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/ecc_design/rtl_to_fv_map.log
}
